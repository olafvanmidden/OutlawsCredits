...
int main() {
    ...
    uintptr_t processID = GetProcessID("Outlaws_plus.exe");
    ...
    // Define startPointer
    uintptr_t startPointer = 0x086BC438;
    ...
    std::vector<int> pointerOffsets = {0x80, 0x8, 0x10, 0x30, 0x8};
    ...
    std::cout << "Current credit value is: " << std::dec << finalAddressValue << "\n" << std::endl;
    ...
    std::cout << "Enter the amount of credits you want:";
    std::cin >> newValue;
    ...
    std::cout << "\nDone!\nCredit value changed to: " << std::dec << newValue << std::endl;
